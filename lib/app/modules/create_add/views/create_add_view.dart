                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          getImageView(
                              index: "1 *",
                              c1: controller.text1Controller.value,
                              c2: controller.pic1Controller.value,
                              ...
                              onTap: () async {
                                ...
                                if (image != null) {
                                  controller.image1 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "2",
                              c1: controller.text2Controller.value,
                              c2: controller.pic2Controller.value,
                              ...
                              onTap: () async {
                                ...
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image2 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "3",
                              c1: controller.text3Controller.value,
                              c2: controller.pic3Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image3 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "4",
                              c1: controller.text4Controller.value,
                              c2: controller.pic4Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image4 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "5",
                              c1: controller.text5Controller.value,
                              c2: controller.pic5Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image5 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "6",
                              c1: controller.text6Controller.value,
                              c2: controller.pic6Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image6 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "7",
                              c1: controller.text7Controller.value,
                              c2: controller.pic7Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image7 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "8",
                              c1: controller.text8Controller.value,
                              c2: controller.pic8Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image8 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "9",
                              c1: controller.text9Controller.value,
                              c2: controller.pic9Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image9 = File(image.path).obs;
                          ...
                          getImageView(
                              index: "10",
                              c1: controller.text10Controller.value,
                              c2: controller.pic10Controller.value,
                              isValidationRequired: false,
                              onTap: () async {
                                final ImagePicker _picker = ImagePicker();
                                PickedFile? image = await _picker.getImage(
                                    source: ImageSource.gallery);
                                if (image != null) {
                                  controller.image10 = File(image.path).obs;
                ...
                child: InkWell(
                  onTap: () {
                    if (controller.formKey.value.currentState!.validate()) {
                      controller.callApiForCreatePost(context: Get.context!);
                    }
                  },
                  child: getButton(
                    title: "SUBMIT",
      ...
      children: [
        ...
        Container(
          ...
          child: getTextField(
            ...
            fillColor: Colors.white,
            // textInputType: TextInputType.number,
            textEditingController: controller.text1Controller.value,
          ),
        ),
        Spacing.height(30),
        Text(
        ...
        Container(
          ...
          child: getTextField(
            ...
            textInputType: TextInputType.number,
            textEditingController: controller.pic1Controller.value,
          ),
        ),
      ],
    );
